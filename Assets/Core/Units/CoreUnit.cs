...
namespace Core.Units {
	...
	public class CoreUnit : ModernAppUnit {
		...
		public override void SetupUnit (ModernComponentsRegistry componentsRegistry) {
			...
			componentsRegistry.Instantiate<SlotsSymbolsFieldProvider>(Instantiate(_fieldViewContextComponentPrefab));
			componentsRegistry.Instantiate<SlotsSymbolsViewModelMapperService>();
